...
export const urlEliminarAspectoGeneral: string = urlFichaTecnicaPlantilla + "EliminarAspectoGeneral"
...
export const urlEliminarEspecificaciones: string = urlFichaTecnicaPlantilla + "EliminarEspecificaciones" 
