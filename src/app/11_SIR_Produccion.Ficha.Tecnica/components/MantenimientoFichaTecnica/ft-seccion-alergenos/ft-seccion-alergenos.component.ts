...
import { FtAlergenosService } from '../../../service/MantenimientoFichaTecnicaServicios/FtAlergenos/FtAlergenos.service';
import { FtAlergenosDTO } from '../../../interface/MantenimientoFichaTecnicaInterface/Alergenos/FtAlergenosDTO';
...
export class FtSeccionAlergenosComponent implements OnInit {
  ...
  public EliminarElemento(alergeno: FtAlergenosDTO) {
    const idAlergeno = alergeno.idAlergeno;
