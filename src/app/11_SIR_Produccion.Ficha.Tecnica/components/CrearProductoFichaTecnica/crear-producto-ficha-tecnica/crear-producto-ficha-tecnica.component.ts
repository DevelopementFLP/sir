...
import { FtMarcaServiceService } from 'src/app/11_SIR_Produccion.Ficha.Tecnica/service/MantenimientoFichaTecnicaServicios/FtMarcas/FtMarcaService.service';
...
public CargarDatosGenerales() {
  ...
  public AgregarCodigo() {
    if (this.codigoProducto!.trim() !== '') {
      ...
      this.codigoProducto = ''; // Limpiar el campo de entrada
    } else {
      Swal.fire({
        title: 'Error',
