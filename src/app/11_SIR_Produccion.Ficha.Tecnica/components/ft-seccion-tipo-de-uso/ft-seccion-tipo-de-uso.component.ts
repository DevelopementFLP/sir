...
import { FtTipoDeUsoService } from '../../service/FtTipoDeUso/FtTipoDeUso.service';
import { FtTipoDeUsoDTO } from './../../interface/TipoDeUso/FtTipoDeUsoDTO';
  ...
  private CargarTiposDeUso(): void {
    this._FtTipoDeUsoService.GetListaDeTiposDeUsoFichaTecnica().subscribe({
      next: (response) => {
        ...
        console.log(this.responseTiposDeUsoDTO);
      },
      error: (error) => {
