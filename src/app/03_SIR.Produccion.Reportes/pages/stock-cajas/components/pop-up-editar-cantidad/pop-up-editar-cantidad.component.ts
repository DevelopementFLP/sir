...
@Component({
  selector: 'app-pop-up-editar-cantidad',
  templateUrl: './pop-up-editar-cantidad.component.html',
  styleUrls: ['./pop-up-editar-cantidad.component.css']
})
export class PopUpEditarCantidadComponent {
  ...
  @Input() cantidadActualCajas!: number;
