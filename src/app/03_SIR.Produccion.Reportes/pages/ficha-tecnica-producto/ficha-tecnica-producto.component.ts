...
import { ImagenesFichaTecnicaExcelService } from '../../services/imagenes-ficha-tecnica-excel.service';

import * as ExcelJS from 'exceljs';
import { saveAs } from 'file-saver';

@Component({
  selector: 'app-ficha-tecnica-producto',
  templateUrl: './ficha-tecnica-producto.component.html',
  styleUrls: ['./ficha-tecnica-producto.component.css']
})
