...
@Component({
  selector: 'app-velocidad-cerrado',
  templateUrl: './velocidad-cerrado.component.html',
  styleUrls: ['./velocidad-cerrado.component.css']
})
export class VelocidadCerradoComponent implements OnInit {
